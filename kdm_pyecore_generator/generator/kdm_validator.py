...
class KDMValidator:
    ...
    def _action_traceability_key(self, action):
        ...
        Priority:
        1. original_id generated by the extractor or relationship mapper;
        2. body_id generated by body mapping;
        3. source region location;
        4. call_id/source_line attributes as a last resort.
        """

        original_id = self._get_attribute_value(action, "original_id")
        ...
        source_line = self._get_attribute_value(action, "source_line")
