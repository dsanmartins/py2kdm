class ElementBuilder:
    ...
    The hierarchical view is preserved in project_model["files"], while this
    builder creates project_model["elements"] as a normalized flat view.
    """
    ...
    def build_elements(self, project_model: dict):
        ...
        for file_model in project_model.get("files", []):
            ...
            for class_model in file_model.get("classes", []):
                ...
                for instance_attribute_model in class_model.get("instance_attributes", []):
    ...
    def _add_project_element(self, project_model: dict):
        """
        Adds the project itself as a root element.
        """
    ...
    def _add_context_variable_elements(
        ...
        Produces an element:
        context_variable:..._write_to_disk.file
        """
